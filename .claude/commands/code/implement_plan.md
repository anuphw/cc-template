...
- At the end execute `run lint` and make sure it passes
- If you want to run any script or python snippet, use the **`uv run`** command followed by the script or snippet name.
