...
You are tasked with conducting comprehensive research across the codebase and the web to answer user questions by spawning parallel sub-agents and synthesizing their findings.
...
5. **Gather metadata for the research document:**
   ...
   - Filename: `thoughts/_shared/research/YYYY-MM-DD_HH-MM-SS_topic.md`
